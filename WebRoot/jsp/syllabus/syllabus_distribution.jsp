                        ...
                        <div id="sample_2_wrapper" class="dataTables_wrapper no-footer">
                            <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                ...
                                <c:forEach var="course" items="${courses}">
                                    <tr class="gradeX" role="row" id="${course.cid}">
                                        <td>${course.cid}</td>
                                        <td>${course.cname}</td>
                                        <td id="label">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="appoint" method="post">
                        <input id="cid" name="course.cid" type="hidden"/>
                        分配给：
                        <select id="tid" name="course.tid" class="select2-container form-control input-small">
                            <option></option>
                ...
                <div class="modal-footer">
                    ...
                    <button id="modelSubmit" type="button" class="btn blue" data-dismiss="modal">确定</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
<script src="/assets/admin/pages/scripts/table-managed-syllabus-distribution.js"></script>
<script>
