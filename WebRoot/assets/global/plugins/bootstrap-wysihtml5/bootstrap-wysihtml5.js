!function($, wysi) {
    ...
    var tpl = {
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn default" + size + "' data-wysihtml5-actions='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class='fa fa-pencil'></i></a>" +
              "</div>" +
            "</li>";
        },
    ...
    Wysihtml5.prototype = {
        ...
        initHtml: function(toolbar) {
            var changeViewSelector = "a[data-wysihtml5-actions='change_view']";
