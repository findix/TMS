...
;(function($, window, document, undefined)
{
    ...
    var defaults = {
            ...
            emptyClass      : 'dd-empty',
            expandBtnHTML   : '<button data-actions="expand" type="button">Expand</button>',
            collapseBtnHTML : '<button data-actions="collapse" type="button">Collapse</button>',
            group           : 0,
            maxDepth        : 5,
            threshold       : 20,
    ...
    Plugin.prototype = {
        ...
        expandItem: function(li)
        {
            ...
            li.children('[data-actions="expand"]').hide();
            li.children('[data-actions="collapse"]').show();
        ...
        collapseItem: function(li)
        {
            ...
            if (lists.length) {
                ...
                li.children('[data-actions="collapse"]').hide();
                li.children('[data-actions="expand"]').show();
        ...
        {
            li.removeClass(this.options.collapsedClass);
            li.children('[data-actions]').remove();
